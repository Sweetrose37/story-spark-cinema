const CACHE='story-spark-mobile-v24';
const CORE=[
  './',
  './index.html',
  './manifest.webmanifest',
  './css/styles.css?v=5.7',
  './assets/story-spark-app-icon.svg',
  './assets/star-code-hero.png',
  './js/idb.js',
  './js/movieComposer.js?v=5.2',
  './js/timelineEditor.js?v=5.1',
  './js/moviePlayer.js?v=5.3',
  './js/mobileMoviePlayer.js?v=1.1',
  './js/movieExporter.js?v=5.1',
  './js/pdfStoryReader.js?v=4.5.2',
