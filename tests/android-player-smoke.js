...
assert(worker.includes("const CACHE='story-spark-mobile-v16'"), 'Installed Android app will not receive the repaired player');
assert(html.includes('js/app-v2.js?v=5.7'), 'Quick-tap player controller is not cache-busted');
