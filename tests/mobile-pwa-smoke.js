...
assert(html.includes('js/mobileApp.js?v=1.2'), 'Mobile app controller is not loaded');
...
assert(worker.includes("const CACHE='story-spark-mobile-v4'"), 'Versioned offline cache is missing');
...
for(const asset of ['./index.html','./manifest.webmanifest','./assets/story-spark-app-icon.svg','./js/mobileApp.js?v=1.2']){
