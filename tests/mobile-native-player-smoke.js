...
assert(html.includes('css/styles.css?v=5.4'),'Dedicated mobile player styles are not cache-busted');
assert(worker.includes("'./js/mobileMoviePlayer.js?v=1.0'"),'Dedicated mobile player is unavailable offline');
assert(worker.includes("const CACHE='story-spark-mobile-v16'"),'Installed phones will not receive the dedicated player');
